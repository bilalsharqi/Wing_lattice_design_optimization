...
def generate_octet_ground_structure(span, chord, depth, ny=21, nx=7, nz=5):
    """
    Dense 3D ground structure with octet/tetra-octa flavor:
    axis links + face diagonals + body diagonals in each cell.
    This is intentionally oversized so pruning can remove material.
    """
